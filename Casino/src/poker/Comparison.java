...
public class Comparison implements Comparable<Comparison>{
	...
	public Comparison(Category c, Hand hand){
		...
		case ROYAL_FLUSH:
			...
			tempHand.setCategory(Category.ROYAL_FLUSH);
			break;
		
		case STRAIGHT_FLUSH: 
			setStraightFlush(myHand); 
			tempHand.setCategory(Category.STRAIGHT_FLUSH);
			break;
			
		case FOUR_OF_A_KIND:
			setFourOfAKind(myHand);
			tempHand.setCategory(Category.FOUR_OF_A_KIND);
			break;
			
		case FULL_HOUSE:
			setFullHouse(myHand);
			tempHand.setCategory(Category.FULL_HOUSE);
			break;
			
		case FLUSH:
			setFlush(myHand);
			tempHand.setCategory(Category.FLUSH);
			break;
			
		case STRAIGHT:
			setStraight(myHand);
			tempHand.setCategory(Category.STRAIGHT);
			break;
			
		case THREE_OF_A_KIND:
			setThreeOfAKind(myHand);
			tempHand.setCategory(Category.THREE_OF_A_KIND);
			break;
			
		case TWO_PAIR:
			setTwoPair(myHand);
			tempHand.setCategory(Category.TWO_PAIR);
			break;
			
		case PAIR:
			setPair(myHand);
			tempHand.setCategory(Category.PAIR);
			break;
			
		case HIGH:
			setHighCard(myHand);
			tempHand.setCategory(Category.HIGH);
			break;
		}//switch(handVal)
	...
	private void setTwoPair(Card[] myHand){		
	...
	*/	
	...
	public String toString(){
		...
		case PAIR:
			if(topCards[0].getType() == Card.Rank.SIX)
				plural = "es";
		...
		case TWO_PAIR:
			...
			if(topCards[1].getType() == Card.Rank.SIX)
				plural = "es";
			else
				plural = "s";
		...
		case STRAIGHT_FLUSH:
			if(topCards[0].getType() == Card.Rank.ACE && topCards[1].getType() == Card.Rank.KING){
				Return = "Royal Flush";
			}
			else
